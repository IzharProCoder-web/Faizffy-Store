...
------------------------------------------------- */
const SkeletonCard = () => (
  <div className="border border-gray-500/20 rounded-md px-1 bg-white w-30 md:w-40 animate-pulse">
    ...
    <div className="text-gray-500/60 text-sm flex flex-col items-start gap-2 mb-2 px-2">
      ...
      <div className="flex items-center gap-0.5">
        {Array(5).fill("").map((_, i) => (
          <div key={i} className="w-3 h-3.5 bg-gray-200 rounded"></div>
        ))}
      ...
      <div className="flex flex-col md:flex-row md:items-end md:justify-between mt-3 w-full">
        ...
        <div className="h-[34px] w-full md:w-[80px] bg-gray-200 rounded mt-3"></div>
      </div>
    </div>
  </div>
)
