import logo from "./FAIZZIFY-LOGO.png";
...
import main_banner_bg from "./new-baner-1.png";
import main_banner_bg_sm from "./new-baner-1-sm.png";
import main_banner_bg_next from "./new-baner-2.png";
import main_banner_bg_next_sm from "./new-baner-2-sm.png";
...
export const categories = [
  {
    ...
    path: "Floral",
    // image: floral_fragrance_image,
    bgColor: "#FEF6DA",
  },
  {
    text: "Woody Scents",
    path: "Woody",
    // image: woody_scent_image,
    bgColor: "#FEE0E0",
  },
  {
    text: "Citrus Perfumes",
    path: "Citrus",
    // image: citrus_perfume_image,
    bgColor: "#F0F5DE",
  },
  {
    text: "Oriental Essences",
    path: "Oriental",
    // image: oriental_essence_image,
    bgColor: "#E1F5EC",
  },
  {
    text: "Aromatic Blends",
    path: "Aromatic",
    // image: aromatic_blend_image,
    bgColor: "#FEE6CD",
  },
  {
    text: "Fresh Aqua Notes",
    path: "Aqua",
    // image: aqua_note_image,
    bgColor: "#E0F6FE",
  },
  {
    text: "Spicy Accents",
    path: "Spicy",
    // image: spicy_accent_image,
    bgColor: "#F1E3F9",
  },
];
