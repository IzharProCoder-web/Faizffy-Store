    ...
    <div className="text-default min-h-screen text-gray-700 bg-white">
      ...
      {!isSellerPath && (
        <a 
          ...
          className="fixed bottom-6 right-6 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-colors duration-200 flex items-center justify-center z-50"
        >
